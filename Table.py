...
class Table:
    ...
    def place_rack(self, ball_diameter):
        ...
        list = [None, POSITION1, POSITION2, POSITION3, POSITION4, POSITION5, POSITION6, POSITION7, POSITION8, POSITION9, POSITION10, POSITION11, POSITION12, POSITION13, POSITION14, POSITION15]
        return list
